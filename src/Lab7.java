...
public class Lab7 extends JPanel implements GLEventListener {
	...
	private void DrawPyramid3d(GL2 gl)
	{
		float vertices3d[] =
				{
						-0.85f,0.0f,0.0f,
		...
		gl.glVertex3f(vertices3d[0],vertices3d[1],vertices3d[2]);
		gl.glTexCoord2d(0.f,0.f);
		gl.glVertex3f(vertices3d[3],vertices3d[4],vertices3d[5]);
		gl.glTexCoord2d(0.f,1.f);
		gl.glVertex3f(vertices3d[6],vertices3d[7],vertices3d[8]);
	...
	private void Pyramid(GL2 gl)
	{
		...
		for (int i = 1; i<n; ++i)
		{
			gl.glPushMatrix();
			{
				gl.glTranslatef(0.f,3.f,0.f);
				gl.glRotatef(i * 30,0.f,0.f, 1.f);
				gl.glTranslatef(0.f,-3.f,0.f);
